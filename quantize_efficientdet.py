...
def parse_args():
    ...
    parser.add_argument("--annotation_file", required=True, help="Path to COCO instances_val2017.json")
    parser.add_argument("--output", default="efficientdet-lite0-int8.tflite", help="Output TFLite file")
...
def main():
    ...
    map50 = evaluate_map(args.output, dataset.take(100), args.annotation_file)
